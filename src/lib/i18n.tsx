...
const tr: Dict = {
  ...
  "faq.q7.a": "React, Next.js, TypeScript, Python, PyTorch, Supabase ve AWS gibi modern teknoloji yığınlarını kullanıyoruz.",
...
const en: Dict = {
  ...
  "faq.q7.a": "We use modern technology stacks such as React, Next.js, TypeScript, Python, PyTorch, Supabase and AWS.",
...
const de: Dict = {
  ...
  "faq.q7.a": "Wir nutzen moderne Technologie-Stacks wie React, Next.js, TypeScript, Python, PyTorch, Supabase und AWS.",
...
const fr: Dict = {
  ...
  "faq.q7.a": "Nous utilisons des piles technologiques modernes telles que React, Next.js, TypeScript, Python, PyTorch, Supabase et AWS.",
...
const es: Dict = {
  ...
  "faq.q7.a": "Utilizamos pilas de tecnología moderna como React, Next.js, TypeScript, Python, PyTorch, Supabase y AWS.",
  ...
  "home.faq.a1": "Fun Technology es una empresa tecnológica especializada en inteligencia artificial, desarrollo de software a medida y transformación digital.",
  "home.faq.a2": "Sí, ofrecemos servicios de soporte técnico y mantenimiento 24 horas al día, 7 días a la semana para sus proyectos.",
  "home.faq.a3": "Aunque varía según el alcance del proyecto, completamos proyectos pequeños en 2 a 4 semanas y proyectos integrales en 2 a 4 meses.",
  "home.faq.a4": "El precio está determinado específicamente por la complejidad de su proyecto y las características necesarias.",
  "home.faq.a5": "Sí, nos especializamos en integrar modelos de IA en sus sistemas existentes.",
  "home.faq.a6": "¡Ciertamente! Puede compartir sus ideas de proyectos con nosotros y obtener asesoramiento gratuito.",
  "home.faq.a7": "Sí, desarrollamos aplicaciones móviles modernas para plataformas iOS y Android.",
...
const az: Dict = {
  ...
  "404.title": "404 - Səhifə tapılmadı",
  ...
  "faq.q7.a": "Biz React, Next.js, TypeScript, Python, PyTorch, Supabase və AWS kimi müasir texnologiya yığınlarından istifadə edirik.",
  ...
  "home.faq.a1": "Fun Technology süni intellekt, xüsusi proqram təminatının hazırlanması və rəqəmsal transformasiya sahəsində ixtisaslaşmış texnologiya şirkətidir.",
  "home.faq.a2": "Bəli, biz layihələriniz üçün 24/7 texniki dəstək və texniki xidmət təklif edirik.",
  "home.faq.a3": "Layihənin əhatə dairəsindən asılı olaraq dəyişsə də, biz kiçik layihələri 2-4 həftə, kompleks layihələri isə 2-4 ay ərzində tamamlayırıq.",
  "home.faq.a4": "Qiymət xüsusi olaraq layihənizin mürəkkəbliyi və tələb olunan xüsusiyyətlər ilə müəyyən edilir.",
  "home.faq.a5": "Bəli, biz AI modellərini mövcud sistemlərinizə inteqrasiya etməkdə ixtisaslaşırıq.",
  "home.faq.a6": "Əlbəttə! Layihə ideyalarınızı bizimlə bölüşüb pulsuz məsləhət ala bilərsiniz.",
  "home.faq.a7": "Bəli, biz həm iOS, həm də Android platformaları üçün müasir mobil proqramlar hazırlayırıq.",
...
const ru: Dict = {
  ...
  "faq.q7.a": "Мы используем современные стеки технологий, такие как React, Next.js, TypeScript, Python, PyTorch, Supabase и AWS.",
  ...
  "home.faq.a1": "Fun Technology — технологическая компания, специализирующаяся на искусственном интеллекте, разработке специального программного обеспечения и цифровой трансформации.",
  "home.faq.a2": "Да, мы предлагаем круглосуточную техническую поддержку и обслуживание ваших проектов.",
  "home.faq.a3": "Хотя это зависит от масштаба проекта, мы выполняем небольшие проекты в течение 2–4 недель, а комплексные проекты – в течение 2–4 месяцев.",
  "home.faq.a4": "Цена зависит от сложности вашего проекта и необходимых функций.",
  "home.faq.a5": "Да, мы специализируемся на интеграции моделей искусственного интеллекта в существующие системы.",
  "home.faq.a6": "Конечно! Вы можете поделиться с нами своими проектными идеями и получить бесплатную консультацию.",
...
const ar: Dict = {
  ...
  "faq.q7.a": "نحن نستخدم مجموعات التكنولوجيا الحديثة مثل React وNext.js وTypeScript وPython وPyTorch وSupabase وAWS.",
  ...
  "home.faq.a1": "Fun Technology هي شركة تكنولوجيا متخصصة في الذكاء الاصطناعي وتطوير البرمجيات المخصصة والتحول الرقمي.",
  "home.faq.a2": "نعم، نحن نقدم خدمات الدعم الفني والصيانة لمشاريعك على مدار الساعة طوال أيام الأسبوع.",
  "home.faq.a3": "على الرغم من أن الأمر يختلف باختلاف نطاق المشروع، إلا أننا ننجز المشاريع الصغيرة في غضون 2-4 أسابيع والمشاريع الشاملة في غضون 2-4 أشهر.",
  "home.faq.a4": "يتم تحديد السعر على وجه التحديد حسب مدى تعقيد مشروعك والميزات المطلوبة.",
  "home.faq.a5": "نعم، نحن متخصصون في دمج نماذج الذكاء الاصطناعي في أنظمتك الحالية.",
  "home.faq.a6": "بالتأكيد! يمكنك مشاركة أفكار مشروعك معنا والحصول على استشارة مجانية.",
  "home.faq.a7": "نعم، نقوم بتطوير تطبيقات الهاتف المحمول الحديثة لكل من منصات iOS وAndroid.",
...
const it: Dict = {
  ...
  "faq.q7.a": "Utilizziamo stack tecnologici moderni come React, Next.js, TypeScript, Python, PyTorch, Supabase e AWS.",
  ...
  "home.faq.a1": "Fun Technology è una società tecnologica specializzata in intelligenza artificiale, sviluppo di software personalizzato e trasformazione digitale.",
  "home.faq.a2": "Sì, offriamo supporto tecnico e servizi di manutenzione 24 ore su 24, 7 giorni su 7 per i tuoi progetti.",
  "home.faq.a3": "Anche se varia a seconda della portata del progetto, completiamo piccoli progetti entro 2-4 settimane e progetti completi entro 2-4 mesi.",
  "home.faq.a4": "Il prezzo è determinato specificamente dalla complessità del progetto e dalle funzionalità necessarie.",
  "home.faq.a5": "Sì, siamo specializzati nell'integrazione di modelli di intelligenza artificiale nei tuoi sistemi esistenti.",
  "home.faq.a6": "Certamente! Puoi condividere con noi le tue idee progettuali e ottenere consulenza gratuita.",
  "home.faq.a7": "Sì, sviluppiamo moderne applicazioni mobili sia per piattaforme iOS che Android.",
...
const pt: Dict = {
  ...
  "faq.q7.a": "Usamos pilhas de tecnologia modernas como React, Next.js, TypeScript, Python, PyTorch, Supabase e AWS.",
  ...
  "home.faq.a1": "A Fun Technology é uma empresa de tecnologia especializada em inteligência artificial, desenvolvimento de software customizado e transformação digital.",
  "home.faq.a2": "Sim, oferecemos suporte técnico e serviços de manutenção 24 horas por dia, 7 dias por semana para seus projetos.",
  "home.faq.a3": "Embora varie dependendo do escopo do projeto, concluímos projetos pequenos em 2 a 4 semanas e projetos abrangentes em 2 a 4 meses.",
  "home.faq.a4": "O preço é determinado especificamente pela complexidade do seu projeto e pelos recursos necessários.",
  "home.faq.a5": "Sim, somos especializados na integração de modelos de IA nos seus sistemas existentes.",
  "home.faq.a6": "Certamente! Você pode compartilhar suas ideias de projeto conosco e obter consultoria gratuita.",
  "home.faq.a7": "Sim, desenvolvemos aplicativos móveis modernos para plataformas iOS e Android.",
...
const ja: Dict = {
  ...
  "faq.q7.a": "私たちは React、Next.js、TypeScript、Python、PyTorch、Supabase、AWS などの最新のテクノロジー スタックを使用しています。",
  ...
  "home.faq.a1": "Fun Technology は、人工知能、カスタム ソフトウェア開発、デジタル変革を専門とするテクノロジー企業です。",
  "home.faq.a2": "はい、お客様のプロジェクトに対して年中無休のテクニカル サポートとメンテナンス サービスを提供します。",
  "home.faq.a3": "プロジェクトの範囲によって異なりますが、小規模プロジェクトであれば2〜4週間、大規模プロジェクトであれば2〜4か月程度で完了します。",
  "home.faq.a4": "価格は、プロジェクトの複雑さと必要な機能によって具体的に決定されます。",
  "home.faq.a5": "はい、当社は AI モデルを既存のシステムに統合することを専門としています。",
  "home.faq.a6": "確かに！あなたのプロジェクトのアイデアを私たちと共有し、無料のコンサルティングを受けることができます。",
  "home.faq.a7": "はい、私たちは iOS と Android の両方のプラットフォーム向けの最新のモバイル アプリケーションを開発しています。",
...
const zh: Dict = {
  ...
  "faq.q7.a": "我们使用现代技术堆栈，例如 React、Next.js、TypeScript、Python、PyTorch、Supabase 和 AWS。",
  "faq.q7.q": "你们使用什么技术？",
  ...
  "home.faq.a1": "趣科技是一家专注于人工智能、定制软件开发和数字化转型的科技公司。",
  "home.faq.a2": "是的，我们为您的项目提供 24/7 技术支持和维护服务。",
  "home.faq.a3": "虽然根据项目范围的不同而有所不同，但我们在2-4周内完成小型项目，在2-4个月内完成综合项目。",
  "home.faq.a4": "定价具体取决于项目的复杂性和所需的功能。",
  "home.faq.a5": "是的，我们专注于将人工智能模型集成到您现有的系统中。",
  "home.faq.a6": "当然！您可以与我们分享您的项目想法并获得免费咨询。",
  "home.faq.a7": "是的，我们为 iOS 和 Android 平台开发现代移动应用程序。",
  "home.faq.badge": "常问问题",
