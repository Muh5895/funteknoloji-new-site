...
const tr: Dict = {  "help.past_tickets": "Geçmiş Destek Talepleriniz",
  ...
  "brand_kit.logos.fun_main.title": "Fun Teknoloji Logosu (Renkli)",
  "brand_kit.logos.fun_white.desc": "Koyu renkli arka planlarda kullanım için beyaz versiyon.",
  ...
  "brand_kit.logos.quakesafe.title": "QuakeSafe Logosu",
...
const de: Dict = {  "help.past_tickets": "Ihre bisherigen Support-Tickets",
  ...
  "brand_kit.logos.nexy.desc": "PNG-Version unseres künstlichen Intelligenz-Assistenten Nexy.",
  "brand_kit.logos.nexy.title": "Nexy",
  "brand_kit.logos.quakesafe.desc": "Offizielles Logo unseres QuakeSafe-Projekts.",
  "brand_kit.logos.quakesafe.title": "QuakeSafe Logo",
  "brand_kit.title": "Markenkit",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Plattform erkunden",
  "nav.open_platform": "Plattform öffnen",
...
const fr: Dict = {  "help.past_tickets": "Vos anciennes demandes de support",
  ...
  "brand_kit.logos.nexy.desc": "Version PNG de notre assistant d'intelligence artificielle Nexy.",
  "brand_kit.logos.nexy.title": "Nexy",
  "brand_kit.logos.quakesafe.desc": "Logo officiel de notre projet QuakeSafe.",
  "brand_kit.logos.quakesafe.title": "Logo QuakeSafe",
  "brand_kit.title": "Trousse de marque",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Explorer la plateforme",
  "nav.open_platform": "Ouvrir la plateforme",
...
const es: Dict = {  "help.past_tickets": "Sus solicitudes de soporte anteriores",
  ...
  "brand_kit.logos.fun_main.desc": "Nuestro logotipo con fondo transparente para uso principal.",
  "brand_kit.logos.fun_main.title": "Logotipo de Fun Teknoloji (Color)",
  "brand_kit.logos.fun_white.desc": "Versión blanca para usar en fondos de colores oscuros.",
  "brand_kit.logos.fun_white.title": "Logotipo blanco de Fun Teknoloji",
  "brand_kit.logos.nexy.desc": "Versión PNG de nuestro asistente de inteligencia artificial Nexy.",
  "brand_kit.logos.nexy.title": "Nexy",
  "brand_kit.logos.quakesafe.desc": "Logotipo oficial de nuestro proyecto QuakeSafe.",
  "brand_kit.logos.quakesafe.title": "Logotipo de QuakeSafe",
  "brand_kit.title": "Kit de marca",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Explorar la plataforma",
  "nav.open_platform": "Abrir la plataforma",
...
const az: Dict = {  "help.past_tickets": "Keçmiş Dəstək Sorğularınız",
  ...
  "brand_kit.logos.fun_main.desc": "Əsas istifadə üçün şəffaf fonlu loqomuz.",
  "brand_kit.logos.fun_main.title": "Fun Teknoloji Loqosu (Rəngli)",
  "brand_kit.logos.fun_white.desc": "Tünd rəngli fonlarda istifadə üçün ağ versiya.",
  "brand_kit.logos.fun_white.title": "Fun Teknoloji Ağ Loqo",
  "brand_kit.logos.nexy.desc": "Süni intellekt köməkçimiz Nexy-nin PNG versiyası.",
  "brand_kit.logos.nexy.title": "Nexy Köməkçi",
  "brand_kit.logos.quakesafe.desc": "QuakeSafe layihəmizin rəsmi loqosu.",
  "brand_kit.logos.quakesafe.title": "QuakeSafe Loqosu",
  "brand_kit.title": "Brend Kiti",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Platformanı Kəşf Edin",
  "nav.open_platform": "Platformanı Açın",
...
const ru: Dict = {  "help.past_tickets": "Ваши прошлые запросы в поддержку",
  ...
  "brand_kit.logos.fun_main.desc": "Наш логотип на прозрачном фоне для основного использования.",
  "brand_kit.logos.fun_main.title": "Логотип Fun Teknoloji (Цветной)",
  "brand_kit.logos.fun_white.desc": "Белая версия для использования на темном фоне.",
  "brand_kit.logos.fun_white.title": "Белый логотип Fun Teknoloji",
  "brand_kit.logos.nexy.desc": "PNG-версия нашего ассистента искусственного интеллекта Nexy.",
  "brand_kit.logos.nexy.title": "Ассистент Nexy",
  "brand_kit.logos.quakesafe.desc": "Официальный логотип нашего проекта QuakeSafe.",
  "brand_kit.logos.quakesafe.title": "Логотип QuakeSafe",
  "brand_kit.title": "Бренд-кит",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Исследовать платформу",
  "nav.open_platform": "Открыть платформу",
...
const ar: Dict = {  "help.past_tickets": "تذاكر الدعم السابقة الخاصة بك",
  ...
  "brand_kit.logos.fun_main.desc": "شعارنا بخلفية شفافة للاستخدام الرئيسي.",
  "brand_kit.logos.fun_main.title": "شعار Fun Teknoloji (ملون)",
  "brand_kit.logos.fun_white.desc": "نسخة بيضاء للاستخدام على الخلفيات داكنة اللون.",
  "brand_kit.logos.fun_white.title": "شعار Fun Teknoloji الأبيض",
  "brand_kit.logos.nexy.desc": "نسخة PNG لمساعد الذكاء الاصطناعي الخاص بنا Nexy.",
  "brand_kit.logos.nexy.title": "مساعد Nexy",
  "brand_kit.logos.quakesafe.desc": "الشعار الرسمي لمشروعنا QuakeSafe.",
  "brand_kit.logos.quakesafe.title": "شعار QuakeSafe",
  "brand_kit.title": "حقيبة العلامة التجارية",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "استكشف المنصة",
  "nav.open_platform": "افتح المنصة",
...
const it: Dict = {  "help.past_tickets": "I tuoi ticket di supporto precedenti",
  ...
  "brand_kit.logos.fun_main.desc": "Il nostro logo con sfondo trasparente per l'uso principale.",
  ...
  "brand_kit.logos.quakesafe.title": "Logo QuakeSafe",
  "brand_kit.title": "Kit del marchio",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Esplora la piattaforma",
  "nav.open_platform": "Apri la piattaforma",
...
const pt: Dict = {  "help.past_tickets": "Seus tickets de suporte anteriores",
  ...
  "brand_kit.logos.fun_main.desc": "Nosso logotipo com fundo transparente para uso principal.",
  "brand_kit.logos.fun_main.title": "Logotipo da Fun Teknoloji (Colorido)",
  "brand_kit.logos.fun_white.desc": "Versão branca para uso em fundos de cores escuras.",
  "brand_kit.logos.fun_white.title": "Logotipo Branco da Fun Teknoloji",
  "brand_kit.logos.nexy.desc": "Versão PNG do nosso assistente de inteligência artificial Nexy.",
  "brand_kit.logos.nexy.title": "Assistente Nexy",
  "brand_kit.logos.quakesafe.desc": "Logotipo oficial do nosso projeto QuakeSafe.",
  "brand_kit.logos.quakesafe.title": "Logotipo do QuakeSafe",
  "brand_kit.title": "Kit de Marca",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "Explorar a Plataforma",
  "nav.open_platform": "Abrir a Plataforma",
...
const ja: Dict = {  "help.past_tickets": "過去のサポートチケット",
  ...
  "brand_kit.logos.fun_main.desc": "メインで使用するための透明な背景のロゴ。",
  "brand_kit.logos.fun_main.title": "Fun Teknoloji ロゴ (カラー)",
  "brand_kit.logos.fun_white.desc": "暗い背景で使用するためのホワイトバージョン。",
  "brand_kit.logos.fun_white.title": "Fun Teknoloji ホワイトロゴ",
  "brand_kit.logos.nexy.desc": "人工知能アシスタントNexyのPNGバージョン。",
  "brand_kit.logos.nexy.title": "Nexy アシスタント",
  "brand_kit.logos.quakesafe.desc": "QuakeSafe プロジェクトの公式ロゴ。",
  "brand_kit.logos.quakesafe.title": "QuakeSafe ロゴ",
  "brand_kit.title": "ブランドキット",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "プラットフォームを探索する",
  "nav.open_platform": "プラットフォームを開く",
...
const zh: Dict = {  "help.past_tickets": "您历史提交的工单",
  ...
  "blog.title": "来自科技世界",
  "brand_kit.badge": "企业级",
  "brand_kit.colors.title": "我们的调色板",
  "brand_kit.colors.purple": "紫色",
  "brand_kit.colors.black": "黑色",
  "brand_kit.desc": "您可以在这里下载 Fun Teknoloji 的徽标和视觉素材，并查看使用指南。",
  "brand_kit.download_png": "下载 PNG",
  "brand_kit.logos.fun_black.desc": "适用于浅色背景的的黑色版本。",
  "brand_kit.logos.fun_black.title": "Fun Teknoloji 黑色徽标",
  "brand_kit.logos.fun_main.desc": "我们用于主要用途的透明背景徽标。",
  "brand_kit.logos.fun_main.title": "Fun Teknoloji 徽标 (彩色)",
  "brand_kit.logos.fun_white.desc": "适用于深色背景的白色版本。",
  "brand_kit.logos.fun_white.title": "Fun Teknoloji 白色徽标",
  "brand_kit.logos.nexy.desc": "我们的智能AI助手 Nexy 的 PNG 版本。",
  "brand_kit.logos.nexy.title": "Nexy 助手",
  "brand_kit.logos.quakesafe.desc": "我们 QuakeSafe 项目的官方徽标。",
  "brand_kit.logos.quakesafe.title": "QuakeSafe 徽标",
  "brand_kit.title": "品牌套件",
  "changelog.badge": "更新",
  ...
  "service.feature.ui_ux": "UI/UX Tasarımı",
  "service.feature.visualization": "Görselleştirme",
  "nav.explore_platform": "探索平台",
  "nav.open_platform": "打开平台",
