        ...
        >
          <nav className="space-y-2" aria-label="Mobil navigasyon">
            <MobileAccordion label={t("nav.company")}>
              <Link
                to="/about"
                className="block rounded-xl px-4 py-3 fun-text-muted hover:bg-[var(--fun-surface)]"
            ...
            <Link
              to="/contact"
              className="block rounded-xl px-4 py-4 font-semibold fun-text hover:bg-[var(--fun-surface)] border-b"
              style={{ borderColor: "var(--fun-stroke-1)" }}
              onClick={() => setMobileOpen(false)}
            >
              {t("nav.contact")}
