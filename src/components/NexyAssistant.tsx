...
export default function NexyAssistant() {
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-4 animate-in slide-in-from-right-10 duration-500 transition-transform ${isThinking && !isOpen ? '-translate-y-4' : 'translate-y-0'}`}>
