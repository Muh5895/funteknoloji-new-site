...
export default function Footer() {
  ...
  return (
    <footer
      className="fun-surface relative overflow-hidden px-4 lg:px-0"
      ...
      <div className="main-container">
        <div className="grid grid-cols-12 gap-x-0 gap-y-12 pt-16 pb-16 lg:gap-x-8 xl:pt-24">
          ...
          <div className="col-span-12 lg:col-span-4">
            <div className="max-w-[306px]">
              ...
              <div className="flex items-center gap-3">
                ...
                <SocialLink href="https://www.linkedin.com/company/fun-teknoloji" label="LinkedIn">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                ...
                <SocialLink href="https://www.youtube.com/@FunTeknoloji" label="YouTube">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.518 3.545 12 3.545 12 3.545s-7.518 0-9.388.508a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.87.508 9.388.508 9.388.508s7.518 0 9.388-.508a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 8.432l6.273 3.568-6.273 3.568V8.432z"
                    />
                  </svg>
                </SocialLink>
                <SocialLink href="https://nsosyal.com/funteknoloji" label="Next Sosyal">
                  <img
                    src={
                      isDark
                        ? "/assets/logos/nextsosyal-white.png"
          ...
          <div className="col-span-12 grid grid-cols-12 gap-x-0 gap-y-8 lg:col-span-8">
            ...
            <div className="col-span-6 md:col-span-3">
              <FooterSection title={t("nav.projects")}>
                <FooterLink to="/projects">{t("nav.projects")}</FooterLink>
                <FooterLink to="/quakesafe">{t("nav.quakesafe")}</FooterLink>
                <FooterLink to="/nexy">{t("nav.nexy")}</FooterLink>
              </FooterSection>
            </div>
            <div className="col-span-6 md:col-span-3">
        ...
        {/* Bottom */}
        <div
          className="flex flex-col items-center justify-between gap-4 border-t py-6 md:flex-row"
          style={{ borderColor: "var(--fun-stroke-1)" }}
        >
          <p className="text-[13px] fun-text-muted">© 2026 Fun Teknoloji. {t("footer.rights")}</p>
          <div className="flex items-center gap-6">
            <a
              href="https://status.funteknoloji.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[13px] fun-text-muted hover:fun-text transition-colors"
            >
              {t("footer.status")}
            </a>
            <Link
...
function SocialLink({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex h-8 w-8 items-center justify-center rounded-full transition-all hover:bg-[var(--fun-card)] fun-text"
      aria-label={label}
    >
      {children}
    </a>
