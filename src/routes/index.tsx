        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, i) => (
            <div key={i} className={`${i === 0 ? "md:col-span-2" : ""} group`}>
              ...
              >
                <aside
                  className={`${i === 0 ? "md:col-span-4" : ""} pt-8 flex flex-col justify-between space-y-5`}
                >
                ...
                <div
                  className={`${i === 0 ? "md:col-span-8" : ""} rounded-xl overflow-hidden min-h-[240px] md:min-h-[300px] transition-transform duration-500 flex items-center justify-center relative`}
                  style={{
                ...
                >
                  ...
                  <div className="text-center p-8 relative z-10">
                    <div
                      className="mx-auto h-20 w-20 rounded-3xl flex items-center justify-center mb-4 transition-all duration-500 shadow-lg text-[var(--fun-purple)]"
                      style={{ backgroundColor: "var(--fun-card)" }}
                    >
                      {service.icon}
                    </div>
                    <p className="text-sm fun-text font-bold tracking-widest uppercase">
                      {service.title}
                    </p>
