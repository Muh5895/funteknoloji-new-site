      ...
      <div className="max-w-[1200px] mx-auto">
        <ScrollReveal>
          <header className="mb-16 text-center">
            <span className="badge-fun badge-fun-purple mb-4 inline-block">{t("brand_kit.badge")}</span>
          ...
          {logos.map((logo, i) => (
            <ScrollReveal key={i}>
              <div className="group h-full rounded-[32px] border border-[var(--fun-stroke-1)] bg-[var(--fun-card)] overflow-hidden transition-all hover:shadow-xl flex flex-col">
                <div className={`aspect-square flex items-center justify-center ${logo.id === 'fun_main' ? 'p-0' : 'p-12'} ${logo.bg}`}>
                  <img
                    src={logo.url}
                    alt={logo.title}
