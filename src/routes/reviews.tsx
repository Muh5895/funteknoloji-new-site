...
function ReviewsPage() {
  const { t } = useLang();
  const reviews = [
    { name: t("reviews.r1.name"), text: t("reviews.r1.text") },
    { name: t("reviews.r2.name"), text: t("reviews.r2.text") },
    { name: t("reviews.r3.name"), text: t("reviews.r3.text") },
    { name: t("reviews.r4.name"), text: t("reviews.r4.text") },
    { name: t("reviews.r5.name"), text: t("reviews.r5.text") },
    { name: t("reviews.r6.name"), text: t("reviews.r6.text") },
  ];
              ...
              <ScrollReveal key={i}>
                <div className="p-8 rounded-[32px] border border-[var(--fun-stroke-1)] bg-[var(--fun-card)] h-full flex flex-col justify-between">
                  ...
                  <div className="mt-8 pt-8 border-t border-[var(--fun-stroke-1)]">
                    ...
                    <p className="text-sm fun-text-muted">{t("reviews.verified")}</p>
                  </div>
                </div>
              </ScrollReveal>
            ))}
