  ...
  head: () => ({
    meta: [
      { title: "Hakkımızda - Fun Teknoloji" },
      {
        name: "description",
        content:
          "Fun Teknoloji, 2025 yılında Muhammed Erbay tarafından kurulan, Türkiye'nin dijital dönüşümüne liderlik etmeyi amaçlayan yenilikçi yapay zeka ve yazılım şirketidir.",
      },
      {
        name: "keywords",
        content:
          "Fun Teknoloji, Muhammed Erbay, teknoloji şirketi, yazılım geliştirme, yapay zeka şirketi, kurumsal yazılım, vizyon ve misyon",
      },
      ...
      { property: "og:title", content: "Hakkımızda - Fun Teknoloji" },
      {
        ...
        content:
          "Türkiye'nin dijital geleceğine öncülük eden Fun Teknoloji'nin vizyonu, misyonu ve kurucu hikayesi hakkında detaylı bilgi alın.",
      },
      ...
      { name: "twitter:title", content: "Hakkımızda - Fun Teknoloji" },
      {
        ...
        content:
          "2025 yılında Muhammed Erbay tarafından kurulan yenilikçi yapay zeka ve yazılım firması Fun Teknoloji.",
      },
      {
        name: "twitter:image",
        content: "https://funteknoloji.com/assets/logos/Fun%20Teknoloji%20Siyah%20Logo.png",
