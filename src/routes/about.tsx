...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fun Teknoloji, 2025 yılında Muhammed Erbay tarafından kurulan, Türkiye'nin dijital dönüşümüne liderlik etmeyi amaçlayan yenilikçi yapay zeka ve yazılım şirketidir." },
      { name: "keywords", content: "Fun Teknoloji, Muhammed Erbay, teknoloji şirketi, yazılım geliştirme, yapay zeka şirketi, kurumsal yazılım, vizyon ve misyon" },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Hakkımızda - Fun Teknoloji" },
      { property: "og:description", content: "Türkiye'nin dijital geleceğine öncülük eden Fun Teknoloji'nin vizyonu, misyonu ve kurucu hikayesi hakkında detaylı bilgi alın." },
      ...
      { name: "twitter:description", content: "2025 yılında Muhammed Erbay tarafından kurulan yenilikçi yapay zeka ve yazılım firması Fun Teknoloji." },
    ...
    <main>
          ...
          <div className="main-container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#12161F] rounded-3xl p-10 md:p-14">
                <span className="badge-fun bg-white/10 text-white mb-6 inline-block">
              ...
              <div
                ...
                style={{ backgroundColor: "var(--fun-green)" }}
              >
                <span
                  className="badge-fun mb-6 inline-block"
                  style={{ backgroundColor: "var(--fun-card)" }}
                >
                  {t("about.vision.badge")}
                </span>
                <h2 className="text-heading-5 md:text-heading-4 font-medium fun-text mb-4">
      ...
      <ScrollReveal>
        <section className="py-16 md:py-24 px-4 lg:px-5">
          <div
            className="max-w-[1880px] mx-auto rounded-3xl py-16 md:py-24"
            style={{ backgroundColor: "var(--fun-surface)" }}
          >
            <div className="main-container">
