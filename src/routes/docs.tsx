      ...
      <div className="max-w-[1290px] mx-auto grid grid-cols-1 lg:grid-cols-4 gap-12 flex-1 w-full">
        <ScrollReveal className="lg:col-span-1">
          <aside className="space-y-8">
            <div>
              <h3 className="font-bold fun-text mb-4 uppercase tracking-widest text-sm opacity-50">
                {t("docs.sidebar.getting_started")}
              </h3>
              <ul className="space-y-3">
                <li>
                  <a
                    href="#"
                    className="fun-text font-medium border-l-2 border-[var(--fun-purple)] pl-4"
                  >
                    {t("docs.sidebar.intro")}
                  </a>
                </li>
                <li>
                  <a href="#" className="fun-text-muted hover:fun-text pl-4">
                    {t("docs.sidebar.setup")}
                  </a>
                </li>
                <li>
                  <a href="#" className="fun-text-muted hover:fun-text pl-4">
                    {t("docs.sidebar.concepts")}
                  </a>
                </li>
              </ul>
            </div>
