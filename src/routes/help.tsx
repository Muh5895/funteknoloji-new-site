...
import { LifeBuoy, MessageCircle, FileText, ShieldQuestion, Mail, Discord } from "lucide-react";
            ...
            <div className="mt-20 p-10 md:p-16 rounded-[40px] bg-[#12161F] text-white text-center relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <ArrowButton
                    href="https://discord.gg/funteknoloji"
                    variant="light"
                    className="h-14 px-8"
                  >
                  ...
                  <ArrowButton
                    to="/contact"
                    variant="dark"
                    className="h-14 px-8 border border-white/20"
                  >
                    {t("contact.title")}
                  </ArrowButton>
                </div>
