...
export const Route = createFileRoute("/team")({
  head: () => ({
    meta: [{ title: "Ekibimiz - Fun Teknoloji" }],
  }),
  component: TeamPage,
});
        ...
        <div className="main-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <ScrollReveal>
              <Link
                to="/contact"
                className="group p-10 rounded-[32px] border-2 border-dashed border-[var(--fun-stroke-1)] flex flex-col items-center justify-center text-center space-y-4 hover:border-[var(--fun-purple)] transition-colors h-full"
              >
