        ...
        <ScrollReveal>
          <div className="max-w-[1880px] mx-auto rounded-3xl xl:rounded-[32px] py-20 md:py-28 px-5 bg-black border border-white/10">
            <div className="main-container text-center">
              ...
              <h1 className="text-heading-2 md:text-heading-1 lg:text-heading-huge font-medium mb-6 text-white capitalize">
                {t("quakesafe.hero.title")}
              </h1>
              <p className="max-w-[800px] mx-auto text-tagline-1 text-slate-400 mb-10">
              ...
              <div className="flex justify-center">
                <ArrowButton
                  ...
                  variant="light"
                  className="h-14 px-8 !bg-white !text-black"
                >
                  {t("nav.open_platform")}
                </ArrowButton>
              </div>
