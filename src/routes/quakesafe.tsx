  ...
  return (
    <main>
      <section className="pt-32 pb-16 px-4 lg:px-5">
        <ScrollReveal>
          <div className="max-w-[1880px] mx-auto rounded-3xl xl:rounded-[32px] py-20 md:py-28 px-5 bg-black border border-white/10">
            <div className="main-container text-center">
              <div className="flex items-center justify-center gap-4 mb-6">
                <img src="/assets/logos/quakesafe_seffaf.png" alt="QuakeSafe" className="h-12 w-12 object-contain" />
                <span className="text-2xl font-bold text-white tracking-tighter">QuakeSafe</span>
              </div>
              <h1 className="text-heading-2 md:text-heading-1 lg:text-heading-huge font-medium mb-6 text-white capitalize">{t("quakesafe.hero.title")}</h1>
              <p className="max-w-[800px] mx-auto text-tagline-1 text-slate-400 mb-10">{t("quakesafe.hero.desc")}</p>
              <div className="flex justify-center">
                <ArrowButton href="https://quakesafe.funteknoloji.com" variant="light" className="h-14 px-8 !bg-white !text-black">
                  {t("nav.open_platform")}
                </ArrowButton>
              </div>
            </div>
