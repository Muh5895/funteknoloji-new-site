            ...
            <div className="main-container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
               <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    <img src="/assets/logos/quakesafe_seffaf.png" alt="QuakeSafe" className="h-20 w-20 object-contain" />
                    <span className="text-4xl font-bold text-white tracking-tighter">QuakeSafe</span>
                  </div>
                  <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
                    {lang === 'tr' ? "Depremden Korkmayın, QuakeSafe ile Güvende Kalın" : "Don't Fear Earthquakes, Stay Safe with QuakeSafe"}
                  </h1>
                  <p className="text-xl text-slate-400 max-w-[600px]">
                    {lang === 'tr'
                      ...
                      : "Revolution in earthquake safety with AI and sensor networks. Your biggest supporter when every second is critical."}
                  </p>
                  <div className="flex flex-wrap gap-4">
                     <ArrowButton href="https://waitlist.funteknoloji.com" variant="light" className="!bg-white !text-[#0F172A]">
                       {lang === 'tr' ? "Bekleme Listesine Katıl" : "Join Waitlist"}
                     </ArrowButton>
                     <ArrowButton href="https://quakesafe.funteknoloji.com" variant="dark" className="border border-white/20">
                       {lang === 'tr' ? "Sistemi Görüntüle" : "View System"}
                     </ArrowButton>
                  </div>
               </div>
