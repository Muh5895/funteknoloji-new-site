        ...
        <div className="main-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, i) => (
              <ScrollReveal key={i} className={i === 0 ? 'md:col-span-2' : ''}>
                <div className={`h-full rounded-3xl p-8 md:p-10 transition-colors duration-500 hover:bg-[var(--fun-surface-hover)] ${i === 0 ? 'grid grid-cols-1 md:grid-cols-2 gap-8' : ''}`} style={{ backgroundColor: 'var(--fun-surface)', border: '1px solid var(--fun-stroke-1)' }}>
