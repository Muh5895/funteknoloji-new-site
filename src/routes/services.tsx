...
function ServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      features: [t("home.features.card2.title"), t("service.feature.ios_android"), t("service.feature.ui_ux"), t("service.feature.performance")]
    },
    {
      title: t("home.services.item2.title"),
      desc: t("home.services.item2.desc"),
      features: [t("service.feature.machine_learning"), t("service.feature.nlp"), t("service.feature.computer_vision"), t("service.feature.automation")]
    },
    {
      title: t("home.services.item4.title"),
      desc: t("home.services.item4.desc"),
      features: [t("service.feature.cloud_migration"), t("service.feature.devops"), t("service.feature.scalability"), t("service.feature.security")]
    },
    {
      title: t("home.services.item5.title"),
      desc: t("home.services.item5.desc"),
      features: [t("service.feature.big_data"), t("service.feature.bi"), t("service.feature.realtime_analytics"), t("service.feature.visualization")]
    },
    {
      title: t("home.services.item6.title"),
      desc: t("home.services.item6.desc"),
      features: [t("service.feature.security_audits"), t("service.feature.pentesting"), t("service.feature.compliance"), t("service.feature.monitoring")]
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, i) => (
              <ScrollReveal key={i} className={i === 0 ? 'md:col-span-2' : 'h-full'}>
                <div className={`h-full rounded-3xl p-8 md:p-10 transition-colors duration-500 hover:bg-[var(--fun-surface-hover)] ${i === 0 ? 'grid grid-cols-1 md:grid-cols-2 gap-8' : 'flex flex-col'}`} style={{ backgroundColor: 'var(--fun-surface)', border: '1px solid var(--fun-stroke-1)' }}>
                  ...
                  <div>
                    <ul className="space-y-3 mt-6 md:mt-0">
                      {service.features.map((f, j) => (
                        <li key={j} className="flex items-center gap-3 rounded-xl p-4 transition-transform hover:translate-x-1" style={{ backgroundColor: 'var(--fun-card)' }}>
